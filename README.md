...
### WARNING! This project is a copy of the original contributors that are mentioned below. The only change it has is in the rendering file of BarChart, to make its bars rounded!!!
